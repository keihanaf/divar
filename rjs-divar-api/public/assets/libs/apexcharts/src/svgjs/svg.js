...
// falls back to 'window' otherwise (for bundlers like Webpack)
  ...
  SVG.FX = SVG.invent({
    ...
    construct: {
    // Get fx modules or create a new one, then animate with given duration and ease
      animate: function (o, ease, delay) {
  ...
  // Add transformations
    ...
    // get target in case of the fx modules, otherwise reference this
      var target = this,
        matrix, bbox
  ...
  // ### This modules adds backward / forward functionality to elements.
  ...
  // Add animatable methods to both gradient and fx modules
